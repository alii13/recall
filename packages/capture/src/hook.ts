...
// SessionEnd hooks have a ~1.5s timeout and cannot block. So this stays a thin
// launcher: read the event JSON from stdin, spawn a detached worker that does
// the slow NIM + embed + insert work with no timeout pressure, and exit fast.
